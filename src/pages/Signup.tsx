            ...
            <div className="relative flex-grow flex items-center justify-center px-6 py-20 overflow-hidden">
                ...
                >
                    <div className="flex flex-col items-center mb-12">
                        ...
                        <h1 className="font-display text-4xl font-bold mb-3 tracking-tighter">Join the Vanguard</h1>
                        <p className="text-white/40 font-light mb-10 tracking-[0.3em] text-[10px] uppercase">Initialize your neural identity</p>
                    </div>
