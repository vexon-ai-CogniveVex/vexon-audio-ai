    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <section className="relative pt-48 pb-32 overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 rounded-full blur-[160px] opacity-50" />
                ...
                <div className="container relative z-10 mx-auto px-6">
                    ...
                    >
                        <span className="text-[10px] tracking-[0.6em] uppercase text-primary font-bold mb-8 block">Project Vexon Intel</span>
                        <h1 className="font-display text-6xl font-bold leading-[1.1] tracking-tight text-white sm:text-7xl md:text-8xl mb-12">
                            Neural <br />
                            <span className="text-white/30 italic font-light">Architecture.</span>
                        </h1>
                        ...
                        {techPillars.map((pillar, i) => (
                            ...
                            >
                                <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
                                    <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center text-primary mb-10 border border-white/10 group-hover:border-primary/50 transition-colors">
                                        <pillar.icon size={32} />
                                    </div>
                                    <h2 className="font-display text-4xl font-bold text-white mb-6 underline decoration-primary/30 decoration-4 underline-offset-8">
                                        {pillar.title}
                                    </h2>
            ...
            <section className="py-40 border-t border-white/5 text-center">
                <div className="container mx-auto px-6">
                    ...
                    >
                        <FiTerminal className="text-primary text-5xl mx-auto mb-10" />
